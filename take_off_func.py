...
#-----------------------------------------------------------------------------------------------------
def noise_grid(runway_lenght, TODR, climb_angle_deg, sound_level, alpha = 1.0e-4, grid_scale=10, grid_points=200, 
               extra_frac = 0.25, npoints = 300, eps = 1.0e-6):
    '''
    '''

    #create grid
    X,Y,x, y, grid_size = grid_def(runway_lenght, grid_scale, grid_points)  

    #build trajectory
    air_x, air_y , air_z = trajectory_s2n(runway_lenght, grid_size, TODR, climb_angle_deg, 
    ...
    return X,Y, Lp_ts, air_x, air_y, air_z